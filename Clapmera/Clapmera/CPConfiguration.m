...
+(void)setOperationMode:(CPConfigurationOperationMode) operationMode{
    [[[GAI sharedInstance] defaultTracker] set:@"operationMode" value:[NSString stringWithFormat:@"%@",@(operationMode)]];
...
+(void)setDelay:(CGFloat)delay{
    [[[GAI sharedInstance] defaultTracker] set:@"setDelay" value:[NSString stringWithFormat:@"%@",@(delay)]];
